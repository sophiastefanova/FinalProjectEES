...
namespace MajorProjectEES
{
    ...
    {
        private string sqlConnection = @"Data Source=LAB109PC16\SQLEXPRESS; Initial Catalog=MajorProjectEES; Integrated Security=True";
        ...
        private void register_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Registration was not succesfull!");
                }
